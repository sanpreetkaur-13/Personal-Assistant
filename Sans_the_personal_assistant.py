...
pyttsx3.speak(" This is Sans,  personal assistant made by Sanpreet. Tell me, you wanna talk to Muskan or Aman?")
print(" Muskan or Aman: ", end = '')
...
with sr.Microphone() as source:
    ...
    #except Exception as e:
       # print("Error: " + str(e))
if ("Muskan" or "Mus" or "Muska" in speaker):
    engine.setProperty('voice', voices[0].id)
elif ("Aman" in speaker):
    engine.setProperty('voice', voices[0].id)
else:
...
pyttsx3.speak("Hey, What's your good name?")
